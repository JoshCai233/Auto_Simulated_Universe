...
class Config:
    def __init__(self):
        ...
        self.text = "info.yml"
        self.skill_char = ['符玄', '阮梅', '爻光', '黄泉', '白厄']

        # 推测定义的是远程角色
        self.long_range_list = ['丹恒饮月', '克拉拉', '青雀', '波提欧', '托帕账账', '彦卿', '符玄', '砂金', '三月七',
                                '娜塔莎', '阮梅', '知更鸟', '布洛妮娅', '艾丝妲', '驭空', '黑天鹅', '瓦尔特杨', '佩拉',
                                '大黑塔', '忘归人', '星期日', '灵砂', '缇宝', '那刻夏', '风堇', '海瑟音', '昔涟',
                                '大丽花', '爻光', '火花']

        self.all_list = ['流萤', '黄泉', '波提欧', '真理医生', '丹恒饮月', '瓦尔特杨', '克拉拉', '银枝', '刃', '希儿',
                         '景元', '镜流', '卡芙卡', '托帕账账', '黑天鹅', '翡翠', '云璃', '砂金', '椒丘', '彦卿', '姬子',
                         '杰帕德', '藿藿', '白露', '阿兰', '素裳', '加拉赫', '知更鸟', '阮梅', '布洛妮娅', '花火',
                         '符玄', '银狼', '罗刹', '寒鸦', '卢卡', '桂乃芬', '虎克', '艾丝妲', '米沙', '佩拉', '黑塔',
                         '三月七', '停云', '桑博', '雪衣', '青雀', '玲可', '驭空', '娜塔莎', '希露瓦', '大黑塔',
                         '忘归人', '星期日', '灵砂', '缇宝', '白厄', '缇宝', '风堇', '丹恒腾荒', 'saber',
                         'archer', '阿格莱雅', '万敌', '那刻夏', '赛飞儿', '瑕蝶', '海瑟音', '刻律德菈', '长夜月',
                         '昔涟', '大丽花', '火花', '爻光', '不死途']
        self.angles = [912, 891, 870, 848, 828, 805, 784, 765, 745, 724, 704, 685, 667, 648, 629, 612, 594, 574, 557,
                       538, 523, 505, 489, 472, 456, 438, 422, 408, 391, 374, 358, 342, 327, 313, 297, 280, 265, 251,
                       235, 222, 205, 192, 160, 146, 134, 118, 101, 87, 73, 59, 44, 28, 12, 0, -14, -31, -45, -56, -76,
                       -89, -99, -117, -131, -145, -152, -173, -196, -206, -221, -235, -255, -268, -284, -297, -311,
                       -329, -339, -354, -375, -391, -407, -422, -440, -457, -473, -486, -506, -523, -540, -555, -576,
                       -592, -613, -630, -649, -668, -687, -707, -725, -744, -765, -786, -807, -827, -849, -872, -893,
                       -907, -918]
